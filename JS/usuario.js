...
const user = {
  ...
  recetas: [
    { id:"r1", titulo:"Pasta Cremosa con Ajo",  img:"../img/pasta_ajo.jpg",        dificultad:"Media", tiempo:"30 min", dietas:["Vegetariano"] },
    { id:"r2", titulo:"Brownies de Chocolate", img:"../img/brownie.jpg",          dificultad:"Baja",  tiempo:"20 min", dietas:["Sin gluten"] },
    { id:"r3", titulo:"Ensalada de Quinoa",    img:"../img/ensalada_quinoa.jpg",  dificultad:"Baja",  tiempo:"15 min", dietas:["Healthy","Vegetariano"] }
  ]
};

// Pintar cabecera
$("#avatarUsuario").src = user.avatar;
$("#username").textContent = "@"+user.username;
$("#nombreUsuario").textContent = user.nombre;

// Botón Mensaje → chat con esa persona
$("#btnMensaje").addEventListener("click", ()=>{
  location.href = `./chat.html?u=${encodeURIComponent(user.id)}&name=${encodeURIComponent(user.username)}`;
});

// Render recetas reutilizando las clases del feed 
...
$("#listaRecetas").innerHTML = user.recetas.map(r => `
